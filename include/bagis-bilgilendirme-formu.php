                    ...
                    <div class="form-group form-center">
                        <div>
                            <div class="checkbox primary">
                                ...
                                <label for="checkbox1">
                                    <a class="btn-link btn-primary pr-0" href="javascript:;" onclick="window.open('/kvkk', 'Ahbap Derneği Kişisel Veriler Politikası', 'width=800,height=750'); return false;">Necat Derneği Kişisel Veriler Politikası</a>'nı okudum ve onaylıyorum.
                                </label>
                            </div>
