<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <a href="<?= SITE ?>proje-liste/<?=$moduller[0]["tablo"]?>" class="btn btn-info" style="float:right; margin-bottom=10px; margin-left:10px;"><i class="fa fa-bars"></i> LİSTE</a>
            </div>
          </div>
    ...
    if ($_POST) {
        if (!empty($_POST["konu"])) {
            ...
            $kontrol = $VT->VeriGetir("projekonulari", "WHERE tablo=?", array($tablo), "ORDER BY ID ASC", 1); // TODO
            if ($kontrol != false) {
                ...
                $ekle = $VT->SorguCalistir("INSERT INTO projekonulari (`konu`, `tablo`, `durum`) VALUES ('$konu','$tablo','$durum')");
                if ($ekle != false) {
