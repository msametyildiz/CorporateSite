                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            ...
                            <input type="checkbox" class="custom-control-input aktifpasif<?= $veriler[$i]['ID'] ?>" id="customSwitch<?= $i ?>" <?= $aktifpasif ?> value="<?= $veriler[$i]["ID"] ?>" onclick="aktifpasif(<?= $veriler[$i]['ID'] ?>,'<?= $kontrol[0]['tablo'] ?>')" ;>
