<?php 
  ...
  if(!empty($_GET["tablo"])){
    ...
    $kontrol=$VT->VeriGetir("moduller","WHERE tablo=? AND durum=?",array($tablo,2),"ORDER BY ID ASC",1);
      ...
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <h1 class="m-0">Proje Konuları</h1>
          ...
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Proje Konuları</li>
                              ...
                              <tr>
                                  ...
                                  <td><?=$sira?></td>
                                    ...
                                    <td><?php
                                       ...
                                       echo stripslashes($veriler[$i]["konu"]); //stripslashes -->html taglarını temizlemiyor
                                    ?></td>
